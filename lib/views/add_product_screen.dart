...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Future <void> _addProduct() async{
    ...
    const String addNewProductUrl="http://152.42.163.176:2008/api/v1/CreateProduct";
    ...
    Response response=await post(uri,body: jsonEncode(inputProduct),headers: {"content-type":"application/json"});
    ...
    if(response.statusCode==200){
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("New Product Failed to Add")));
    }
